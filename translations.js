const translations = {
    en: {
        ...
        projects: {
            ...
            p3: {
                label: "VW Group",
                title: "IT Portfolio Assessment",
                desc: "Evaluated multi-million EUR IT project portfolio to maximize business value and ROI across the Volkswagen Group production division."
            },
            p4: {
                label: "Personal",
                title: "AI Agents & Experiments",
                desc: "Building and experimenting with AI agents, exploring practical applications of large language models.",
                link: "View on GitHub"
            }
        },
        work: {
            ...
            roles: [
                ...
                {
                    title: "Intern FSO Business Consulting",
                    company: "EY",
                    date: "2023",
                    desc: "Third-party risk management for banking clients. Assessed technology vendors for regulatory compliance."
                }
            ]
        },
        education: {
            ...
            certs: [
                { status: "In Progress", name: "AI Product Manager Professional Certificate - Microsoft" },
    ...
    es: {
        ...
        education: {
            ...
            certs: [
                { status: "En Progreso", name: "Certificado Profesional AI Product Manager - Microsoft" },
                { status: "2024", name: "AI Python for Beginners - DeepLearning.ai" },
                { status: "2024", name: "AI Agents in LangGraph - DeepLearning.ai" }
            ]
        },
